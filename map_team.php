...
// icons with dots:
//      source: http://maps.google.com/mapfiles/ms/micons/{colour}-dot.png
//      colours: blue, green, ltblue (lightblue), orange, pink, purple, red, yellow
// icons without dots:
//      source: http://maps.google.com/mapfiles/ms/micons/{colour}.png
//      colours: blue, green, lightblue, orange, pink, purple, red, yellow
// icon pushpin:
//      source: http://maps.google.com/mapfiles/ms/micons/{colour}-pushpin.png
//      colours: red, blue, ylw(yellow), grn (green), purple, orange, ltblu (lightblue), pink
