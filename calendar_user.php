      ...
      <div class="container-fluid">
        ...
        <!-- /.row -->
        		...
        		<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  ...
                  <input type="hidden" name="team_id" class="form-control" id="team_id" value="">
                  <input type="hidden" name="user_id" class="form-control" id="user_id" value="<?php echo $_SESSION['user_id'];?>">
